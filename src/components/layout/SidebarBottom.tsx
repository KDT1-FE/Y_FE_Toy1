      ...
      <MobileSidebarBottomBox>
        <div>
          <a href="https://www.notion.so/X-24f85bf2ff4e4c69bd45ddc4e05d464b" target="_blank" rel="noreferrer">
            <img className="svg_icon" src={process.env.PUBLIC_URL + "/svg/icon/notion_icon.svg"} alt="notion" />
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <img className="svg_icon" src={process.env.PUBLIC_URL + "/svg/icon/sheet_icon.svg"} alt="sheet" />
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <img className="svg_icon" src={process.env.PUBLIC_URL + "/svg/icon/zoom_icon.svg"} alt="zoom" />
          </a>
        </div>
      </MobileSidebarBottomBox>
    );
    ...
    return (
      <SidebarBottomBox>
        ...
        <a href="https://app.slack.com/client/T057XJP4T34/C05FRTBDHDL" target="_blank" rel="noreferrer">
          <img src={process.env.PUBLIC_URL + "/svg/ETC/AttendanceQR.svg"} alt="QR코드" />
        </a>
        <div>
          <a href="https://www.notion.so/X-24f85bf2ff4e4c69bd45ddc4e05d464b" target="_blank" rel="noreferrer">
            <img className="svg_icon" src={process.env.PUBLIC_URL + "/svg/icon/notion_icon.svg"} alt="notion" />
